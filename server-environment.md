...
*   [shmop](https://www.php.net/manual/en/book.shmop.php) – Allows PHP to read, write, create and delete Unix shared memory segments
...
*   [apcu](https://www.php.net/manual/en/book.apcu) – in-memory key-value store for PHP (former APC stripped of opcode caching), to be used with a plugin such as [APCu Manager](https://wordpress.org/plugins/apcu-manager/).
